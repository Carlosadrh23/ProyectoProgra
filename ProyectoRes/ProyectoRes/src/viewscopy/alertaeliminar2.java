...
public class alertaeliminar2 {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    alertaeliminar2 window = new alertaeliminar2();
                    window.frame.setVisible(true); // También cambié null por true
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void initialize() {
        frame = new JFrame(); // ← CORRECCIÓN: Sin "JFrame" al inicio
