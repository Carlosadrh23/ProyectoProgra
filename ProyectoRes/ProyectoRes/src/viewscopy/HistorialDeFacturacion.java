...
public class HistorialDeFacturacion {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HistorialDeFacturacion window = new HistorialDeFacturacion();
	...
	private void initialize() {
		...
		String[][] datos = {
		    {"LOPR8402", "Laura Fernanda Mendoza Ruiz", "$155"},
		    {"XACM7501", "Esteban Ríos Calderón", "$189"},
		    {"RODJ9011", "Camila Duarte Sánchez", "$200"},
		    {"TEAG8010", "Marcos Antonio Salgado Varela", "$550"},
		    {"FAGM8512", "Tomás Eduardo Aguirre Morales", "$978"},
		    {"VELD9203", "Valeria Ponce Rodríguez", "$1200"},
		    {"NOMI9302", "Rafael Ibáñez Castillo", "$1555"},
